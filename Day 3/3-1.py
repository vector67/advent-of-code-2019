    ...
    for i in range(1, len(wire1)):
        ...
        if len(intersection_points) > 0:
            ...
            if closest_intersection_point_distance == -1:
                closest_intersection_point_distance = abs(intersection_points[0][0]) + abs(intersection_points[0][1])
            for intersection_point in intersection_points:
                manhattan_distance = abs(intersection_point[0]) + abs(intersection_point[1])
